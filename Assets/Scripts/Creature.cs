...
public class Creature : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (playerIsLooking && !wasLookingLastFrame)
        {
            turnsUsed++;

            Debug.Log("Giro número: " + turnsUsed);
        }

        
        bool canRepelCreature = playerIsLooking && turnsUsed <= maxTurns;

        
        wasLookingLastFrame = playerIsLooking;
